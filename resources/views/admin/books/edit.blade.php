    ...
    <div class="main">
        ...
        <header class="topbar">
            <div class="topbar-breadcrumb">
                ...
                <span class="breadcrumb-current">Edit Buku</span>
            </div>
        ...
        <main class="content">
            ...
            <div class="page-header">
                <h1>Edit Buku</h1>
                <p>Perbarui informasi buku: <strong>{{ $book->judul }}</strong></p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.books.update', $book) }}" enctype="multipart/form-data"
                ...
                <div class="form-grid">
                    ...
                    <div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <i data-lucide="file-text" width="16" height="16"
                                ...
                                <div class="field">
                                    ...
                                    <div class="input-wrap">
                                        ...
                                        <input type="text" name="judul" value="{{ old('judul', $book->judul) }}"
                                            ...
                                            class="{{ $errors->has('judul') ? 'input-error' : '' }}" required>
                                    </div>
                                    @error('judul')
                                        <div class="error-msg"><i data-lucide="circle-alert" width="12"
                                                height="12"></i> {{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="input-wrap">
                                            ...
                                            <input type="text" name="pengarang"
                                                ...
                                                class="{{ $errors->has('pengarang') ? 'input-error' : '' }}" required>
                                        </div>
                                        @error('pengarang')
                                            <div class="error-msg"><i data-lucide="circle-alert" width="12"
                                                    height="12"></i> {{ $message }}</div>
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="input-wrap">
                                            ...
                                            <input type="text" name="isbn"
                                                value="{{ old('isbn', $book->isbn) }}" placeholder="978-xxx-xxx"
                                                class="{{ $errors->has('isbn') ? 'input-error' : '' }}" required>
                                        </div>
                                        @error('isbn')
                                            <div class="error-msg"><i data-lucide="circle-alert" width="12"
                                                    height="12"></i> {{ $message }}</div>
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="input-wrap">
                                            ...
                                            <input type="text" name="kode_rak"
                                                value="{{ old('kode_rak', $book->kode_rak) }}"
                        ...
                        <div class="card">
                            <div class="card-header">
                                <i data-lucide="align-left" width="16" height="16"
                                    style="color:var(--green)"></i>
                            ...
                            <div class="card-body">
                                <div class="field">
                                    ...
                                    <textarea name="deskripsi" rows="5" placeholder="Tulis sinopsis atau deskripsi singkat buku...">{{ old('deskripsi', $book->deskripsi) }}</textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="card" style="margin-bottom:20px;">
                            ...
                            <div class="card-body">
                                <div class="cover-preview" id="coverPreview"
                                    ...
                                    @if ($book->cover)
                                        <img src="{{ Storage::url($book->cover) }}" id="coverImg" alt="Cover">
                                        <div class="cover-overlay">
                                            <i data-lucide="camera" width="22" height="22"
                                                style="color:white"></i>
                                            <span>Ganti Cover</span>
                                        </div>
                                    @else
                                        <i data-lucide="image-plus" width="32" height="32"
                                            style="color:var(--text-muted)" id="coverIcon"></i>
                                        <span class="cover-placeholder-text" id="coverPlaceholder">Klik untuk upload
                                            cover</span>
                                        <span class="cover-placeholder-sub">JPG, PNG — maks 2MB</span>
                                    @endif
                                </div>
                                <input type="file" name="cover" id="coverInput" accept="image/*">
                                <p
                                    style="font-size:11.5px; color:var(--text-muted); margin-top:10px; text-align:center;">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <i data-lucide="package" width="16" height="16"
                                    style="color:var(--green)"></i>
                            ...
                            <div class="card-body">
                                ...
                                <div class="field">
                                    ...
                                    <div class="input-wrap">
                                        ...
                                        <input type="number" name="total_stok" id="stokInput"
                                            value="{{ old('total_stok', $book->total_stok) }}" placeholder="0"
                                            min="0"
                                            class="{{ $errors->has('total_stok') ? 'input-error' : '' }}" required
                                    ...
                                    <div class="stok-display">
                                        <span class="stok-label">Jumlah eksemplar</span>
                                        <span class="stok-val"
                                            id="stokDisplay">{{ old('total_stok', $book->total_stok) ?? '0' }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="field">
                                    ...
                                    <div class="kondisi-options">
                                        @foreach ([['value' => 'Baik', 'label' => 'Baik', 'dot' => 'dot-Baik', 'sel' => 'selected-Baik'], ['value' => 'Rusak', 'label' => 'Rusak', 'dot' => 'dot-Rusak', 'sel' => 'selected-Rusak']] as $opt)
                                            @php $isSelected = old('kondisi', $book->kondisi) == $opt['value']; @endphp
                                            <label class="kondisi-option {{ $isSelected ? $opt['sel'] : '' }}"
                                                onclick="selectKondisi(this, '{{ $opt['value'] }}', '{{ $opt['sel'] }}')">
                                                <input type="radio" name="kondisi" value="{{ $opt['value'] }}"
                                                    {{ $isSelected ? 'checked' : '' }}>
                                    ...
                                    @error('kondisi')
                                        <div class="error-msg" style="margin-top:6px"><i data-lucide="circle-alert"
                                                width="12" height="12"></i> {{ $message }}</div>
                                    @enderror
                                </div>
    ...
    <script>
        ...
        document.getElementById('coverInput').addEventListener('change', function(e) {
            ...
            reader.onload = function(ev) {
                ...
                preview.innerHTML = `
            <img src="${ev.target.result}" style="width:100%;height:100%;object-fit:cover;position:absolute;inset:0;">
            <div class="cover-overlay" style="position:absolute;inset:0;background:rgba(26,58,42,0.55);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:6px;opacity:0;transition:opacity 0.18s;">
                <i data-lucide="camera" width="22" height="22" style="color:white"></i>
                <span style="color:white;font-size:13px;font-weight:600;">Ganti Cover</span>
            </div>`;
                lucide.createIcons();
                preview.onmouseenter = () => preview.querySelector('.cover-overlay').style.opacity = '1';
                preview.onmouseleave = () => preview.querySelector('.cover-overlay').style.opacity = '0';
            };
            reader.readAsDataURL(file);
        });

        // Kondisi selection
        function selectKondisi(el, value, selClass) {
            document.querySelectorAll('.kondisi-option').forEach(opt => {
                opt.classList.remove('selected-Baik', 'selected-Rusak');
            });
